...
layout: article 
title: "Handwriting"
era: "Human history since, at least, 3200 BC"
subheading: "Tool"
...
## __Ratchet Effect__
From my (handwritten) notes for Terry Regier's class _Language and Thought_: on Tomasello's 1999 _The Cultural Origins of Human Cognition_ <a href="{{ '/assets/files/tomasello-COHC-ch1.pdf' | relative_url }}" target="_blank" rel="noopener">View PDF</a>

- Homo sapiens are very different from the rest of Homo 
    - what's different?
        1. tool use 
        2. Symbolic communication 
        3. Social practices 
- Large change happened in a very brief period of time, evolutionarily speaking. How did this happen? 


### Cultural Transmission via the Rachet effect
- Cultural transmission: the faithful transmission of ideas, innovations for the next generation
    - If you 'slipped', you would have to start over from scratch 
- Humans don't start from scratch 
    - We pool cognitive resources in ways that other animals cannot, including the ability to faithfully transmit knowledge across generations 
    - Building upon the innovations of others 

- the cultural traditions and artifacts of humans accumulate modifications over time in a way that those of other species do not.
    - Ex: This is central to science - understand what predecessors have claimed, found, or disproved 
...
- We can learn not just _from_ the other, but THROUGH others 
